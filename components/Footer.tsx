    ...
    <footer className="bg-background border-t">
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p>
            &copy; {new Date().getFullYear()} Matthew J Peters. All rights
            reserved.
          </p>
          <div className="flex space-x-4 mt-4 md:mt-0">
            <Link
              href="https://github.com/mattsterp"
              target="_blank"
            ...
            <Link
              href="https://linkedin.com/in/mattsterp"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
            >
            ...
            <Link
              href="https://twitter.com/mattsterp"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Twitter"
            >
